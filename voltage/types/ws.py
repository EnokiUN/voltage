...
if TYPE_CHECKING:
    from .server import MemberPayload, MemberIDPayload, ServerPayload
    from .channel import ChannelPayload, DMChannelPayload, GroupDMChannelPayload, SavedMessagePayload, TextChannelPayload, VoiceChannelPayload
    from .message import MessagePayload, EditedPayload
    from .user import UserPayload, StatusPayload
...
OnChannelCreatePayload = Union[OnChannelCreatePayload_SavedMessage, OnChannelCreatePayload_Group, OnChannelCreatePayload_DMChannel, OnChannelCreatePayload_VoiceChannel, OnChannelCreatePayload_TextChannel]
