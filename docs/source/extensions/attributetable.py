# The attributetable extensions is blatantly copied from discord.py (https://github.com/Rapptz/discord.py)
# and is licensed under the MIT license.
# Copyright (c) 2015-2020 Rapptz

# Voltage does not claim ownership of the attributetable extension and has not added a single line of code to it.
